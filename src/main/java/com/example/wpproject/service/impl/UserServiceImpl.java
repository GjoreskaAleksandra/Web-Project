...
public class UserServiceImpl implements UserService {
    ...
    @Override
    public User register(String name, String surname, String email, String username, String password, String repeatPassword, Role role) {
        ...
        User user = new User(name, surname, email, username, passwordEncoder.encode(password), role);
